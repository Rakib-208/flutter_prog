...
import 'package:flutter_prog/views/order_screen.dart';
...
void main() {
  ...
  group('OrderScreen - Cart Summary', () {
    ...
    testWidgets('updates cart summary when items are added to cart', (
      ...
      final Finder addToCartButtonFinder = find.widgetWithText(
        StyledButton,
        'Add to Cart',
      );
    ...
    testWidgets(
      'updates cart summary when quantity is increased before adding',
  ...
  group('OrderScreen - Interactions', () {
    ...
    testWidgets('updates sandwich type when a new option is selected', (
      ...
      final Finder sandwichDropdownFinder = find.byType(
        DropdownMenu<SandwichType>,
      );
      await tester.tap(sandwichDropdownFinder);
      await tester.pumpAndSettle();

      final Finder chickenTeriyakiOptionFinder = find
    ...
    testWidgets('quantity does not go below zero and buttons are disabled', (
      ...
      final Finder removeButtonFinder = find.widgetWithIcon(
        IconButton,
        Icons.remove,
      );
      await tester.ensureVisible(removeButtonFinder);
      ...
      final StyledButton styledButton = tester.widget<StyledButton>(
        addToCartButtonFinder,
      );
    ...
    testWidgets('navigates to cart view when View Cart button is tapped', (
      ...
      final Finder viewCartButtonFinder = find.widgetWithText(
        StyledButton,
        'View Cart',
      );
  ...
  group('StyledButton', () {
    testWidgets('renders correctly with icon and label when enabled', (
      ...
      const MaterialApp testApp = MaterialApp(home: Scaffold(body: testButton));
